<template>
  <div class="reports-wrapper">
    <div class="header-section">
      ...
      <p class="subtitle">Análisis estadístico de tus atenciones y desempeño.</p>
    </div>
    ...
    <div v-else-if="stats" class="dashboard-grid">
      ...
      <div class="chart-card glass-card">
        <div class="chart-header">
          <h4>Patient Acquisition Growth</h4>
      ...
      <div class="chart-card glass-card">
        <div class="chart-header">
          <h4>Distribución de Ganancia Mensual</h4>
          <div class="main-metric">
      ...
      <div class="chart-card glass-card success-breakdown">
        <h4>Appointment Success Breakdown</h4>
...
const chartOptions = {
  ...
  elements: {
    line: { tension: 0.4 } // Curvas suaves (smooth curves)
  }
}
...
<style scoped>
.reports-wrapper { max-width: 900px; margin: 0 auto; padding-bottom: 2rem; }
...
@media (min-width: 768px) {
  ...
  .success-breakdown { grid-column: span 2; max-width: 50%; } /* Keep it reasonably sized on large screens */
}
...
.chart-header h4 { margin: 0 0 0.5rem 0; color: #64748b; font-size: 0.9rem; font-weight: 600; }
.main-metric { display: flex; align-items: baseline; gap: 0.5rem; }
.main-metric h2 { margin: 0; font-size: 2rem; color: #0f172a; font-weight: 800; }
...
.success-breakdown h4 {
  margin: 0 0 1.5rem 0; color: #0f172a; font-size: 1.1rem; font-weight: 800;
}
