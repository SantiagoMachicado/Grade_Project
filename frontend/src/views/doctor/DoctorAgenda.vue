<template>
  <div class="placeholder-container">
    <div class="header-section">
      ...
      <p class="subtitle">Gestiona tus horarios y atenciones.</p>
    </div>

    <div class="placeholder-content glass-card">
      <div class="empty-state">
        <div class="empty-icon">📆</div>
        <h3>Módulo de Agenda Próximamente</h3>
        <p>Pronto podrás visualizar tu calendario médico mensual e interactuar con citas programadas.</p>
      </div>
    </div>
  </div>
</template>
