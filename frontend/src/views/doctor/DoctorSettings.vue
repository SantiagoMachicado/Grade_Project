  ...
  <div class="placeholder-container">
    <div class="header-section">
      <div class="title-with-icon">
        ...
        <h2>Ajustes Profesionales</h2>
      </div>
      <p class="subtitle">Configuración de perfil médico, horarios de atención y credenciales.</p>
    </div>

    <div class="placeholder-content glass-card">
      <div class="empty-state">
        <div class="empty-icon">🛠️</div>
        <h3>Configuración Próximanente</h3>
        <p>Aquí se consolidarán las opciones para alterar tu especialidad, número de colegiatura y disponibilidad general.</p>
      </div>
    </div>
  </div>
</template>
