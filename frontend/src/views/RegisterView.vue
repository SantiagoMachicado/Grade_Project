<template>
  <div class="auth-wrapper">
    <div class="auth-card">
      ...
      <h1 class="main-title">Únete a nosotros</h1>
      <p class="subtitle">Crea tu cuenta para gestionar tus citas de forma rápida y segura.</p>
      ...
      <form @submit.prevent="handleRegister" class="auth-form">
        ...
        <div class="form-group">
          ...
          <div class="password-input">
            <input :type="showPassword ? 'text' : 'password'" v-model="form.password" placeholder="Mínimo 8 caracteres" required minlength="8" />
        ...
        <button type="submit" class="btn-primary" :disabled="isLoading" style="margin-top: 1rem;">
      ...
      <div class="footer-links">
        <span>¿Ya tienes cuenta?</span> <RouterLink to="/login" class="link-text">Inicia sesión</RouterLink>
      </div>
    </div>
  </div>
</template>
...
const form = reactive({
  ...
  email: '',
  password: '',
  role: 'paciente' // Siempre paciente ahora
})
...
.auth-wrapper {
  ...
  padding: 2rem 0; /* Un poco de padding para que se vea bien si hay scroll */
}
...
.hero-image {
  width: 100%;
  height: 160px; /* Un poco más pequeño que en login para dejar espacio a los campos extra */
